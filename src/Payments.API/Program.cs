...
app.MapGet("/payments", () => Results.Ok(new[] { new { Name = "Payments 1" }, new { Name = "Payments 2" } }));
app.MapGet("/payments/{id}", (int id) => Results.Ok(new { Name = $"Payments {id}" }));
app.MapPost("/payments", () => Results.Created("/payments/1", new { Name = "Payments 1" }));
app.MapPut("/payments/{id}", (int id) => Results.NoContent());
app.MapDelete("/payments/{id}", (int id) => Results.NoContent());
