...
app.MapGet("/bills", () => Results.Ok(new[] { new { Name = "Bill 1" }, new { Name = "Bill 2" } }));
app.MapGet("/bills/{id}", (int id) => Results.Ok(new { Name = $"Bill {id}" }));
app.MapPost("/bills", () => Results.Created("/bills/1", new { Name = "Bill 1" }));
